...
let StockBatteriesController = class StockBatteriesController {
    constructor(stockBatteriesService) {
...
], StockBatteriesController.prototype, "create", null);
__decorate([
    Get('/all'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StockBatteriesController.prototype, "findAll", null);
__decorate([
    Get(),
    __param(0, Query()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], StockBatteriesController.prototype, "findOne", null);
__decorate([
    Patch('/update'),
    __param(0, Body()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], StockBatteriesController.prototype, "update", null);
__decorate([
    Delete('/remove'),
    __param(0, Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [GetStockDto]),
    __metadata("design:returntype", void 0)
], StockBatteriesController.prototype, "remove", null);
StockBatteriesController = __decorate([
    Controller('stock/battery'),
    __metadata("design:paramtypes", [StockBatteriesService])
], StockBatteriesController);
export { StockBatteriesController };
