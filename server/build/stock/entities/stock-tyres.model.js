...
let StockTyres = class StockTyres extends Model {
};
__decorate([
    Column({ type: DataType.INTEGER, unique: true, autoIncrement: true, primaryKey: true }),
    __metadata("design:type", Number)
], StockTyres.prototype, "id", void 0);
__decorate([
    ForeignKey(() => Tyres),
    Column({ type: DataType.INTEGER }),
    __metadata("design:type", Number)
], StockTyres.prototype, "id_tyre", void 0);
__decorate([
    Column({ type: DataType.INTEGER, unique: false, allowNull: true }),
    __metadata("design:type", Number)
], StockTyres.prototype, "stock", void 0);
__decorate([
    Column({ type: DataType.INTEGER, unique: false, allowNull: true, defaultValue: 0 }),
    __metadata("design:type", Number)
], StockTyres.prototype, "reserve", void 0);
__decorate([
    Column({ type: DataType.INTEGER, unique: false, allowNull: true,
        get() {
    ...
    __metadata("design:type", Number)
], StockTyres.prototype, "remainder", void 0);
__decorate([
    ForeignKey(() => Supplier),
    Column({ type: DataType.INTEGER }),
    __metadata("design:type", Number)
], StockTyres.prototype, "id_supplier", void 0);
__decorate([
    ForeignKey(() => Storage),
    Column({ type: DataType.INTEGER, defaultValue: 1 }),
    __metadata("design:type", Number)
], StockTyres.prototype, "id_storage", void 0);
__decorate([
    Column({ type: DataType.DATE, unique: false, allowNull: false }),
    __metadata("design:type", Date)
], StockTyres.prototype, "update_date", void 0);
__decorate([
    BelongsTo(() => Tyres, 'id_tyre'),
    __metadata("design:type", Tyres)
], StockTyres.prototype, "tyres", void 0);
__decorate([
    BelongsTo(() => Supplier, 'id_supplier'),
    __metadata("design:type", Supplier)
], StockTyres.prototype, "supplier", void 0);
__decorate([
    BelongsTo(() => Storage, 'id_storage'),
    __metadata("design:type", Storage)
], StockTyres.prototype, "storage", void 0);
StockTyres = __decorate([
