...
let TyreBrand = class TyreBrand extends Model {
};
__decorate([
    Column({ type: DataType.INTEGER, unique: true, allowNull: false, primaryKey: true, autoIncrement: false }),
    __metadata("design:type", Number)
], TyreBrand.prototype, "id_brand", void 0);
__decorate([
    Column({ type: DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], TyreBrand.prototype, "brand", void 0);
__decorate([
    HasMany(() => Tyres, 'id_brand'),
    __metadata("design:type", Array)
], TyreBrand.prototype, "tyres", void 0);
__decorate([
    HasMany(() => RatingTyres, 'id_brand'),
    __metadata("design:type", Array)
], TyreBrand.prototype, "ratings", void 0);
__decorate([
    HasMany(() => ReviewTyres, 'id_brand'),
    __metadata("design:type", Array)
], TyreBrand.prototype, "reviews", void 0);
TyreBrand = __decorate([
