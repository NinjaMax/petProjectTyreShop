...
let WheelModel = class WheelModel extends Model {
};
__decorate([
    Column({ type: DataType.INTEGER, unique: true, allowNull: false, primaryKey: true, autoIncrement: false }),
    __metadata("design:type", Number)
], WheelModel.prototype, "id_model", void 0);
__decorate([
    Column({ type: DataType.STRING, unique: false, allowNull: false }),
    __metadata("design:type", String)
], WheelModel.prototype, "model", void 0);
__decorate([
    HasMany(() => Wheel, 'id_model'),
    __metadata("design:type", Array)
], WheelModel.prototype, "wheels", void 0);
WheelModel = __decorate([
